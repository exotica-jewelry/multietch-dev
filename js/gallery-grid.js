(() => {
  ...
  var scaleFactor = getComputedStyle($gallery).getPropertyValue("--grid-gallery-scale-factor");
  var getTimeouts = () => {
    const durationOn = parseFloat(getComputedStyle($gallery).getPropertyValue("--grid-gallery-duration-expand"));
